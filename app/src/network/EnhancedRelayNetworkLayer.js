...
export class EnhancedRelayNetworkLayer {
    _uri: string;
 ...
 */
function throwOnServerError(request: RelayMutationRequest,
                            response: any): any {
 ...
 */
function formatRequestErrors(request: RelayMutationRequest | RelayQueryRequest,
                             errors: Array<GraphQLError>): string {
...
function createRequestError(request: RelayMutationRequest | RelayQueryRequest,
